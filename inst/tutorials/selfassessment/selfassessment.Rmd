...
quiz(
  ...
  question("Following from Question 1 above, you are given that the 95th percentile (or 0.975) quantile of the $t$ distribution with 7 degrees of freedom is 2.365 (you can find this manually using this [t-distribution table](http://statcalculators.com/students-t-distribution-table/) or try using `R`: `qt(0.975, df=7)`). Calculate a 95% confidence interval for $\\bar{x}$.",
  ...
  question("Using the evidence you found with the p-value above, at the $\\alpha = 0.05$ level, do you reject or fail to reject the null hypothesis?",
          ...
          answer("Fail to reject $H_0$. There is no evidence against the null hypothesis."),
          answer("I'm not sure"),
          ...
          allow_retry=TRUE,
          try_again = "Try again",
          incorrect="Not quite - try again! Hint: check out this [helpful link](https://online.stat.psu.edu/statprogram/reviews/statistical-concepts/hypothesis-testing/p-value-approach) or this [helpful video](https://www.khanacademy.org/math/ap-statistics/tests-significance-ap/one-sample-t-test-mean/v/comparing-p-value-from-t-statistic-to-significance-level)")
)
