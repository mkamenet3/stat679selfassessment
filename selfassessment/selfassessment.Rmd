...
quiz(
  ...
  question("Following from Question 1 above, the t-statistics is 2.365 (you can find the statistics manually using this [t-distribution table](http://statcalculators.com/students-t-distribution-table/). Calculate a 95% confidence interval for $\\bar{x}$).",
    ...
    allow_retry = TRUE,
    try_again_button = "Try again"),
  question("Continuing with the example above, suppose you know that for the U.S. population, the average number of hours someone spends listening to music per day is 8.3 hours. You would like to test the hypothesis that $$H_0: \\mu = 8.3$$ vs. $$H_0: \\mu \\neq 8.3$$ Recall that from Question 1, $\\bar{x}=5$, $s=3.63$, $n=8$. Use the t-distribution to calculate the $t$ test statistics.",
  answer("-2.41"),
  answer("-2.57", correct=TRUE),
  answer("-7.27"),
  answer("3.9"),
  correct="Correct! The $t$ test statistics is given by $\\frac{\\bar{x} - \\mu_0}{s/\\sqrt{n}} = \\frac{5 - 8.3}{3.63/\\sqrt{8}}$.  For more information, please refer to Moore, McCabe, and Craig Ch.7 or check out this [helpful link](https://www.statisticshowto.com/one-sample-t-test/)",
  incorrect="Not quite - try again! Hint: check out this [helpful link](https://www.statisticshowto.com/one-sample-t-test/)",
    allow_retry = TRUE,
    try_again_button = "Try again"),
  question("Suppose that using a national survey of college students on a distant planet, the mean debt after a single year of college is $2,100 and $1,700 after a single year of community college, yielding a difference of $400. You are given that the standard deviation for this difference is $300. Calculate the z-statistic ($z^*$).",
    answer("2.67"),
    answer("1.33", correct=TRUE),
    answer("23.09"),
    answer("0"),
    incorrect="Not quite - try again!. Hint: check out this [helpful link](https://www.statisticshowto.com/probability-and-statistics/z-score/)",
    allow_retry = TRUE,
    try_again_button = "Try again",
    correct = "Correct! To calculate the z-statistic, we can take $z= \\frac{\\text{estimate - hypothesized value}}{\\text{standard deviation of the estimate}} = \\frac{400-0}{300} = 1.33$. For more information, please refer to Moore, McCabe, and Craig Chapter 6.2 or check out this [helpful link](https://www.statisticshowto.com/probability-and-statistics/z-score/)."),
  question("Using the z-statistic ($z^*$) calculated in the previous problem and [this Normal distribution table](https://www.math.arizona.edu/~rsims/ma464/standardnormaltable.pdf), calculate $$P(Z \\leq z^*)$$",
    answer("0.90824", correct= TRUE),
    answer("0.09176"),
    answer("0.11702 "),
    answer("0.90320"),
    incorrect="Not quite - try again!. Hint: check out this [helpful link](https://www.youtube.com/watch?v=bir8WtfCeW0)",
    allow_retry = TRUE,
    try_again_button = "Try again",
    correct = "Correct! For more information, please refer to Moore, McCabe, and Craig Chapter 6.2 or check out this [helpful link](https://www.youtube.com/watch?v=bir8WtfCeW0).")
)
...
- All examples adapted from Moore, McCabe, Craig *Introduction to the Practice of Statistics*.
